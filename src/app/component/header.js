        ...
        <header>
            ...
            {<nav className={`mobile-nav ${menuOn ? 'menuActive' : 'menuInactive'}`}>
                ...
                <dl>
                    ...
                    <dd><Link href="/page/archive?category=학과전시" onClick={() => setMenuOn(false)}><span>학과 전시</span></Link></dd>
                    <dd><Link href="/page/archive?category=졸업전시" onClick={() => setMenuOn(false)}><span>졸업 전시</span></Link></dd>
                </dl>
