              ...
              <section>
                ...
                {aboutButton ? (
                  <div className='karts-wrap'>
                   <div style={{display:'flex',flexWrap:'wrap', gap:'1.458vw'}}>
                      <p style={{fontFamily:'SUIT', fontSize:'0.8333vw', flex:'1 1 40%', lineHeight:'1.4583vw'}}>
                      ...
                      <p style={{fontFamily:'Moderat',fontSize:'0.8333vw', flex:'1 1 40%',lineHeight:'1.3542vw'}}>
