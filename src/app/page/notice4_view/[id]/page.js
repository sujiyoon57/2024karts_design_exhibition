...
export default async function Notice4(props){

    const id = parseInt(props.params.id);
    const data = await fetchContentful('notice4');
    ...
    return(
        ...
        <div className="notiview-container">
            ...
            <div className="notiview-back"><Link href='/page/notice4'>Back to List</Link></div> 
        </div>
    );
}
